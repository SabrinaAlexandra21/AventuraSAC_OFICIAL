...
public class TipotelaJpaController implements Serializable {
    ...
    public void create(Tipotela tipotela) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (findTipotela(tipotela.getIdTipo()) != null) {
                throw new PreexistingEntityException("Tipotela " + tipotela + " already exists.", ex);
            }
            throw ex;
        } finally {
            if (em != null) {
