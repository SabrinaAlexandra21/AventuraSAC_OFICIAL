...
public class Proveedor implements Serializable {
    ...
    public Proveedor(Integer idProveedor, String razonSocial, String direccion, String contacto, String correo) {
        this.idProveedor = idProveedor;
    ...
    public String toString() {
        return "model.entities.Proveedor[ idProveedor=" + idProveedor + " ]";
    }
